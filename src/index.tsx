...
<title>Flapy™ — Недвижимость Астаны</title>
<script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"></script>
<style>
:root{--bg:#F8F6F3;--bg2:#FFFFFF;--bg3:#F0EDE8;--navy:#1E2D5A;--orange:#F47B20;--green:#27AE60;--t1:#2D3748;--t2:#6B7280;--t3:#9CA3AF;--brd:#E5E7EB;--nav-h:60px;--bot-h:64px}
...
.tabs{display:flex;gap:20px;margin:12px 16px 0;border-bottom:2px solid var(--brd);padding-bottom:2px}
...
<div id="app">
  ...
  <div class="tabs">
    <div class="tab on" id="tab-all" onclick="switchTab('all')">💰 Продажа</div>
...
<div class="overlay" id="m-add" onclick="if(event.target===this)closeM('m-add')">
  <div class="sheet">
    ...
    <textarea class="finput" id="a-desc" rows="3" placeholder="Описание объекта..."></textarea>
