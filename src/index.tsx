  ...
  <div class="splash-content">
    <div class="splash-logo">
      <svg class="splash-house" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
        <!-- Крыша -->
        <path class="house-roof" d="M10 40 L50 10 L90 40" stroke="#FF9A3C" stroke-width="2.5" fill="none"/>
        <!-- Тело дома -->
        <rect class="house-body" x="20" y="40" width="60" height="50" rx="4" fill="#FFE5D0"/>
        <!-- Окна -->
        <rect class="window window-1" x="30" y="50" width="12" height="12" rx="2" fill="#FF9A3C"/>
        <rect class="window window-2" x="58" y="50" width="12" height="12" rx="2" fill="#FF9A3C"/>
        <rect class="window window-3" x="44" y="70" width="12" height="12" rx="2" fill="#FF9A3C"/>
        <!-- Дверь -->
        <rect class="door" x="42" y="75" width="16" height="15" rx="2" fill="#FFB380"/>
        <!-- Дым из трубы -->
        <circle class="chimney-smoke" cx="70" cy="30" r="3" fill="#A0AEC0"/>
        <circle class="chimney-smoke smoke-2" cx="73" cy="25" r="2.5" fill="#A0AEC0"/>
        <circle class="chimney-smoke smoke-3" cx="76" cy="20" r="2" fill="#A0AEC0"/>
      </svg>
    </div>
