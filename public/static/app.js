/* ════════════════════════════════════════════════════
   FLAPY v6.0 — Тёплая палитра + Место силы
   Фон: #FFFBF7 | Основной: #FF9A3C (мягкий персик)
════════════════════════════════════════════════════ */

:root {
  /* 🎨 Тёплая мягкая палитра */
  --white: #FFFFFF;
  --bg: #FFFBF7;
  --bg2: #FFFFFF;
  --bg3: #FFF5EB;
  ...
  --sh: 0 2px 8px rgba(91,141,190,0.08);
  --sh2: 0 8px 24px rgba(91,141,190,0.12);
...
.splash-house {
  width: 100%;
  height: 100%;
  animation: housePulse 2.5s ease-in-out infinite;
}

.house-roof {
  stroke-dasharray: 120;
  stroke-dashoffset: 120;
  animation: drawRoof 1.2s ease forwards 0.3s;
  stroke: var(--orange);
  stroke-width: 2.5;
  fill: none;
}
...
.window {
  opacity: 0;
  fill: var(--orange);
  animation: lightUp 0.4s ease forwards;
}
.window-1 { animation-delay: 1.6s; }
.window-2 { animation-delay: 1.9s; }
.window-3 { animation-delay: 2.2s; }
...
.chimney-smoke {
  opacity: 0;
  fill: var(--t3);
  animation: smokeFloat 2s ease-in-out infinite 3s;
}
...
@keyframes smokeFloat {
  ...
  50% { opacity: 0.6; transform: translateY(-5px) scale(1.2); }
}
...
[data-theme="dark"] #app-shell { background: #0F172A; }
...
.ld-icon {
  ...
  align-items: center;
  justify-content: center;
  box-shadow: 0 4px 16px rgba(91,141,190,0.25);
}
.ld-name {
  font-size: 30px;
  font-weight: 900;
...
.ld-bar {
  ...
  border-radius: 2px;
  animation: ldA 1.4s ease forwards;
}
...
.lcard-media {
  position: relative;
  height: 185px;
  background: linear-gradient(135deg, #FFF5EB, #FFE5D0);
  overflow: hidden;
  display: flex;
  align-items: center;
  justify-content: center;
}
[data-theme="dark"] .lcard-media {
...
.ltag.exch {
  background: rgba(125,190,143,0.15);
  color: var(--green);
  border-color: rgba(125,190,143,0.25);
}
...
.fc-chip.exch {
  background: rgba(125,190,143,0.25);
  color: #9FD4A8;
  border-color: rgba(125,190,143,0.4);
}
...
[data-theme="dark"] .compose-tab.on {
  background: var(--orange);
  border-color: var(--orange);
}
...
.rel-sort::-webkit-scrollbar { display: none; }
...
.info-box {
  ...
  align-items: flex-start;
  gap: 7px;
  background: rgba(125,190,143,0.1);
  border: 1px solid rgba(125,190,143,0.2);
  border-radius: 10px;
  padding: 9px 11px;
  margin-bottom: 11px;
  font-size: 12px;
...
.det-photos::-webkit-scrollbar { display: none; }
...
#toast {
  ...
  background: rgba(91,141,190,0.95);
  color: #fff;
  border-radius: 10px;
  padding: 9px 16px;
  font-size: 12px;
